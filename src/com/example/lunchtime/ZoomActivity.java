...
//
//		playButton = (View)findViewById(R.id.button_main_play);
//		practiceButton = (View)findViewById(R.id.button_main_practice);
//		rewardsButton = (View)findViewById(R.id.button_main_rewards);
//
...
//    	
//        final View thumb1View = findViewById(R.id.button_main_play);
//		Handler handler = new Handler(); 
//	    handler.postDelayed(new Runnable() { 
//	         public void run() { 
//	        	 zoomAnimation(thumb1View, R.drawable.playbutton, R.id.expanded_image_play, mpPlayButton);
//	         } 
//	    }, 1000); 
//	    
//
...
//	    handler.postDelayed(new Runnable() { 
//	         public void run() { 
//	            	zoomAnimation(thumb2View, R.drawable.button_main_practice,  R.id.expanded_image_practice, mpPractice);
//	         } 
//	    }, 9500); 
//	    
//
//        final View thumb3View = findViewById(R.id.button_main_rewards);
//	    handler.postDelayed(new Runnable() { 
//	         public void run() { 
//	            	zoomAnimation(thumb3View, R.drawable.button_main_rewards,  R.id.expanded_image_rewards, mpRewards);
//	         } 
//	    }, 13500); 
//	    
//	    handler.postDelayed(new Runnable() { 
